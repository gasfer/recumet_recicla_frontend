...
export class SidebarComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  icon: 'fa-solid fa-balance-scale', // Nivel 1
  subItems: [
    // 🚛 BALANZA CAMIONERA
    {
      id: 51,
      ...
      icon: 'fa-solid fa-truck-fast', // Nivel 2
      subItems: [
        {
          id: 52,
          ...
          icon: 'fa-solid fa-plus-circle', // Nivel 3
        },
        {
          id: 53,
          ...
          icon: 'fa-solid fa-search', // Nivel 3
        },
      ],
    },
    ...
    // ⚖️ BALANZA MANUAL
    {
      ...
      icon: 'fa-solid fa-weight-scale', // Nivel 2
      subItems: [
        {
          id: 55,
          ...
          icon: 'fa-solid fa-clipboard-list', // Nivel 3
        },
        {
          id: 56,
          ...
          icon: 'fa-solid fa-chart-line', // Nivel 3
        },
      ],
    },
    ...
    // 🧮 SERVICIO DE BALANZA
    {
      ...
      icon: 'fa-solid fa-calculator', // Nivel 2
      subItems: [
        {
          id: 58,
          ...
          icon: 'fa-solid fa-circle-plus', // Nivel 3
        },
        {
          id: 59,
          ...
          icon: 'fa-solid fa-list-check', // Nivel 3
        },
      ],
    },
    ...
    // 👤 TRANSPORTISTAS
    {
      ...
      icon: 'fa-solid fa-user-tie', // Nivel 2
      subItems: [
        {
          id: 61,
          ...
          icon: 'fa-solid fa-user-plus', // Nivel 3
        },
        {
          id: 62,
          ...
          icon: 'fa-solid fa-users-viewfinder', // Nivel 3
        },
      ],
    },
    ...
    // 🚚 CAMIONES
    {
      ...
      icon: 'fa-solid fa-truck-pickup', // Nivel 2
      subItems: [
        {
          id: 64,
          ...
          icon: 'fa-solid fa-plus-square', // Nivel 3
        },
        {
          id: 65,
          ...
          icon: 'fa-solid fa-list-ul', // Nivel 3
        },
      ],
    },
  ],
